...
<nav class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <img src="<?= BASE_URL ?>assets/img/LOGO1.png" alt="CRDMS Logo">
        </div>
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/dashboard.php" class="<?php echo ($current_page == 'dashboard.php' || $current_page == 'dashboard_modern.php') ? 'active' : ''; ?>" title="Dashboard Overview">
        ...
        <li>
            <a href="<?= BASE_URL ?>public/certificate_of_live_birth.php" class="<?php echo $current_page == 'certificate_of_live_birth.php' ? 'active' : ''; ?>" title="Register Birth Certificate">
                <i data-lucide="file-text"></i> <span>Birth Certificate</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/certificate_of_marriage.php" class="<?php echo $current_page == 'certificate_of_marriage.php' ? 'active' : ''; ?>" title="Register Marriage Certificate">
                <i data-lucide="file-signature"></i> <span>Marriage Certificate</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/certificate_of_death.php" class="<?php echo $current_page == 'certificate_of_death.php' ? 'active' : ''; ?>" title="Register Death Certificate">
                <i data-lucide="file-minus"></i> <span>Death Certificate</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/application_for_marriage_license.php" class="<?php echo $current_page == 'application_for_marriage_license.php' ? 'active' : ''; ?>" title="Marriage License Application">
        ...
        <li>
            <a href="<?= BASE_URL ?>public/birth_records.php" class="<?php echo $current_page == 'birth_records.php' ? 'active' : ''; ?>" title="View & Manage Birth Records">
                <i data-lucide="folder"></i> <span>Birth Records</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/marriage_records.php" class="<?php echo $current_page == 'marriage_records.php' ? 'active' : ''; ?>" title="View & Manage Marriage Records">
                <i data-lucide="folders"></i> <span>Marriage Records</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/death_records.php" class="<?php echo $current_page == 'death_records.php' ? 'active' : ''; ?>" title="View & Manage Death Records">
                <i data-lucide="folder-closed"></i> <span>Death Records</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/marriage_license_records.php" class="<?php echo $current_page == 'marriage_license_records.php' ? 'active' : ''; ?>" title="View & Manage Marriage License Applications">
                <i data-lucide="folder-search"></i> <span>License Records</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/folder_browser.php" class="<?php echo $current_page == 'folder_browser.php' ? 'active' : ''; ?>" title="Browse Records by Folder">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/archives.php" class="<?php echo $current_page == 'archives.php' ? 'active' : ''; ?>" title="Archived Records">
                <i data-lucide="archive"></i> <span>Archives</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>public/trash.php" class="<?php echo $current_page == 'trash.php' ? 'active' : ''; ?>" title="View, Restore & Permanently Delete Records">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/reports.php" class="<?php echo $current_page == 'reports.php' ? 'active' : ''; ?>" title="Generate & View Reports">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/reorganize_uploads.php" class="<?php echo $current_page == 'reorganize_uploads.php' ? 'active' : ''; ?>" title="Reorganize Upload Folders">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/users.php" class="<?php echo $current_page == 'users.php' ? 'active' : ''; ?>" title="Manage System Users">
                <i data-lucide="users"></i> <span>Users</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>admin/security_logs.php" class="<?php echo $current_page == 'security_logs.php' ? 'active' : ''; ?>" title="Security Event Logs">
                <i data-lucide="shield"></i> <span>Security Logs</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>admin/activity_logs.php" class="<?php echo $current_page == 'activity_logs.php' ? 'active' : ''; ?>" title="User Activity Logs">
                <i data-lucide="history"></i> <span>Activity Logs</span>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL ?>admin/settings.php" class="<?php echo $current_page == 'settings.php' ? 'active' : ''; ?>" title="System Configuration">
