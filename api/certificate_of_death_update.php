...
requireAuth();
requireCSRFToken();
if (!hasPermission('death_edit')) { json_response(false, 'Permission denied.', null, 403); }
...
try {
    ...
    try {
        ...
        $sql = "UPDATE certificate_of_death SET
                    ...
                    date_of_birth_partial_year = :date_of_birth_partial_year,
                    date_of_birth_partial_day = :date_of_birth_partial_day,
